...
function Navbar() {
  ...
  useEffect(() => {
    ...
    console.log("true",
      pathname === "/landing-page-new" || "/landing-page-new/thankyou"
    );
    if (pathname === "/landing-page-new" || pathname === "/landing-page-new/thankyou") {
      setHeaderHide(true);
    } else {
      setHeaderHide(false);
    }
  ...
  return (
    <>
      {!headerHide && (
        <div className="">
          {/* for large screens  */}
          <div className="font-saira hidden lg:flex px-24 py-4 bg-themeBlue text-white justify-between">
            <div className="left">
              <Link href={"/"}>
                <Image
                  src={
